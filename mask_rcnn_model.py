...
color_image_paths = sorted([os.path.join(test_data_dir, img) for img in os.listdir(test_data_dir) if img.endswith('_color.png')])
mask_image_paths = sorted([os.path.join(test_data_dir, img) for img in os.listdir(test_data_dir) if img.endswith('_mask.png')])
